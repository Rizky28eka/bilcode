...
@section('content')
    ...
    <main>
        <div class="top">
            @auth
                <div class="message">
                    <a href="/development/blog" class="btn__back">
            ...
            <form action="/development/blog" method="post" enctype="multipart/form-data">
                @csrf
                ...
                <div class="card__body-input">
                    <div>
                        <textarea class="form-control" id="body" name="body" placeholder="Enter body" name="body"></textarea>
                    </div>
                </div> --}}
    ...
    <script>
        ...
        title.addEventListener('change', function() {
            fetch('/development/blog/checkSlug?title=' + title.value)

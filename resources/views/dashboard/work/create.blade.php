...
@section('content')
            ...
            <form action="/development/work" method="post" enctype="multipart/form-data">
                        ...
                        <div id="file-upload-form" class="uploader">
                            ...
                            <label for="file-upload" id="file-drag">
                                ...
                                <div id="start">
                                    ...
                                    <span id="file-upload-btn" class="table__preview">Select a file</span>
                                </div>
                ...
                <div class="card__body-input">
                    <div>
                        ...
                        <textarea class="form-control" input="body" id="body" name="body" value="{{ old('body') }}" placeholder="Enter body"></textarea>
                    </div>
                </div>
    ...
    <script>
        ...
        const listItems = ["Website", "Mobile App", "Dashboard"];
        ...
        const listItemTemplate = (text, translateValue, id) => {
        return `
            <li class="dropdown-list-item">
                <button type="button" class="dropdown-button list-button" data-translate-value="${translateValue}%">
        ...
        document.documentElement.style.setProperty("--rotate-arrow", deg !== 0 ? deg + "deg" : 0);
        document.documentElement.style.setProperty("--dropdown-height", ht !== 0 ? ht + "rem" : 0);
        document.documentElement.style.setProperty("--list-opacity", opacity);
        };
        ...
        const currDropdownHeight =
            document.documentElement.style.getPropertyValue("--dropdown-height") || "0";
        ...
        document.documentElement.style.setProperty("--translate-value", translateValue);
        });
        ...
        const iconSize = document.documentElement.style.getPropertyValue("--floating-icon-size") || 0;
        ...
        document.documentElement.style.setProperty("--floating-icon-left", x - iconSize / 2 + "px");
        document.documentElement.style.setProperty("--floating-icon-top", y - iconSize / 2 + "px");
        });
